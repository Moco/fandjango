...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Friend'
        db.create_table('fandjango_friend', (
        ...
        db.send_create_signal('fandjango', ['Friend'])

        # Adding model 'Like'
        db.create_table('fandjango_like', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('category', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='likes', to=orm['fandjango.User'])),
        ))
        db.send_create_signal('fandjango', ['Like'])


    def backwards(self, orm):
        
        # Deleting model 'Friend'
        db.delete_table('fandjango_friend')

        # Deleting model 'Like'
        db.delete_table('fandjango_like')
    ...
    models = {
        'fandjango.friend': {
            ...
            'friend_of': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'friends'", 'to': "orm['fandjango.User']"}),
        ...
        'fandjango.like': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'likes'", 'to': "orm['fandjango.User']"})
        },
